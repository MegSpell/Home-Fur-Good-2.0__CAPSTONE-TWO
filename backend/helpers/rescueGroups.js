...
// /** Build filters array from query params (NO breed filter here) */
// function buildFiltersFromQuery(q) {
//   const filters = [];
...
//   // 🔴 NO breed filters here — we handle breeds locally later
//   return filters;
// }

// /** Build filterRadius for ZIP + miles */
// function buildFilterRadius(q) {
//   const zip = q.zip;
//   const miles = Number(q.miles) || 50;
//   if (!zip) return undefined;

//   return { postalcode: zip, miles };
// }

// /** Search available dogs (has picture). Breed filtering happens in routes/dogs.js */
// export async function searchAvailableDogs(query) {
//   if (!API_KEY) {
//     throw { status: 500, message: "Missing RESCUEGROUPS_API_KEY" };
//   }
...
//   // Keep limits reasonable but still big for infinite scroll
//   const apiLimit = hasBreedFilter ? 200 : 150;
//   const page = 1;
...
//       ...(filterRadius ? { filterRadius } : {}),
//     },
//     include: ["pictures", "locations"],
//     // ❗ No "fields" restriction — get full attributes so mapping has everything
...
// /** Get a single dog by ID with details + pictures */
// export async function getDogById(id) {
//   if (!API_KEY) {
//     throw { status: 500, message: "Missing RESCUEGROUPS_API_KEY" };
//   }
