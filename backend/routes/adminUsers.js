...
//     // We’ll require newUsername + email in practice, since the form always sends them.
//     if (newUsername) {
//       fields.push(`username = $${idx++}`);
//       values.push(newUsername);
//     }
...
//     // Zipcode can be empty string, so we check for undefined rather than falsy
//     if (zipcode !== undefined) {
//       fields.push(`zipcode = $${idx++}`);
//       values.push(zipcode);
//     }
...
//     // WHERE original username = :username
//     values.push(username);
