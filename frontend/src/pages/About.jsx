...
//   // Only logged-in users can view About
//   if (!user) {
//     return <Navigate to="/login" replace />;
//   }
...
//         <h1>About Home Fur Good 2.0</h1>
//         <p className="about-lead">
//           Home Fur Good 2.0 is a demo adoption app built by Meghan as part of the
//           Springboard Software Engineering Career Track. It&apos;s inspired by
//           real rescue pups and the incredible organizations who help dogs find
//           safe, loving homes.
//         </p>
...
//     <h2>About Meghan</h2>
//     <p>
//       Meghan has spent much of her life working hands-on with animals — from
//       managing an Olympic-level horse farm for over 16 years to rescuing and
//       caring for dogs who needed a second chance. After years building
//       structure, organization, and trust in real-world settings, she made
//       the leap into software engineering through the Springboard Software
//       Engineering Career Track.
//     </p>

//     <p>
//       Her love of dogs — especially Archer, Albus and Andy — became the
//       driving force behind Home Fur Good 2.0. Meghan believes technology can
//       make a meaningful difference in the rescue world by helping overlooked
//       pups get seen, shared, and ultimately adopted.
//     </p>

//     <p>
//       Whether writing code, training horses, or giving a nervous shelter dog
//       a warm place to land, Meg brings determination, compassion, and a fierce
//       commitment to helping animals find their people.
//     </p>
//   </div>
...
//           >
//             <div className="rescue-logo-wrap">
//               <img src={rtrLogo} alt="Ruff Tales Rescue" className="rescue-logo" />
//             </div>
//             <h3>Ruff Tales Rescue</h3>
//             <p>New England foster-based rescue — home of Archer.</p>
//           </a>
...
//           >
//             <div className="rescue-logo-wrap">
//               <img src={lhk9Logo} alt="Last Hope K9" className="rescue-logo" />
//             </div>
//             <h3>Last Hope K9 Rescue</h3>
//             <p>Boston-based rescue helping Southern dogs find their people, like Albus!</p>
//           </a>
...
//           >
//             <div className="rescue-logo-wrap">
//               <img src={tulsaLogo} alt="Tulsa Animal Welfare" className="rescue-logo" />
//             </div>
//             <h3>Tulsa Animal Welfare</h3>
//             <p>
//               Andy’s starting point — a shelter working hard for Tulsa’s lost
