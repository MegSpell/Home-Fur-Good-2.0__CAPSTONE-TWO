...
//   // Core search fields
//   // ----------------------------------------------------------
//   const [zip, setZip] = useState("10001"); // default ZIP (can be changed by user)
//   const [miles, setMiles] = useState(50);  // search radius
...
//   useEffect(() => {
//     const qsZip = searchParams.get("zip");
//     if (!qsZip) return; // If no zip in URL, we keep defaults.
...
//   // Restore from URL (so when we come back from /results, the form is prefilled)
//   useEffect(() => {
//     const qsZip = searchParams.get("zip");
//     if (!qsZip) return;
...
//     // Update URL on /search (so form state is shareable)
//     setSearchParams(params);
