...
//               hasPic: true,
//             }),
//             getFavoriteCountsPublic(), // { dogId: count, ... }
//           ]);
...
//       } catch (err) {
//         console.error("Error loading spotlight dogs:", err);
//         setSpotlightDogs([]); // fail safe: no crash, just no spotlight
//       }
//     }
...
//             <h1>Welcome to HOME FUR GOOD, {user?.username}!</h1>
//             <p>
//               Discover adoptable dogs, save your favorites, and potentially give a pup in need their FURever home! Let's get started! 
//             </p>
...
//             <p className="spotlight-subtitle">
//               {hasZip
//                 ? "These are some of the least-favorited dogs near your area. Maybe one of them is your next best friend! Just look at those faces! Check them out!"
//                 : "These pups haven’t been favorited much yet across the app. So we wanted to spotlight them to give them a little extra boost at finding their FURever home. Look at those faces! Please consider adopting one of these adorable"}
//             </p>
